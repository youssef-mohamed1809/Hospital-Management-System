...
public class LoginViewController implements Initializable {
    ...
    void loadSecretaryScreen(ActionEvent event) throws IOException, SQLException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("appointments-view.fxml"));
        root = loader.load();
        //AppointmentsViewController appointmentsViewControllerViewController = loader.getController();
        //appointmentsViewControllerViewController.load(id);
    ...
    void loadDoctorScreen(ActionEvent event) throws IOException, SQLException {
